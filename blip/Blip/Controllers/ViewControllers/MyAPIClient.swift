...
class MyAPIClient: NSObject, STPEphemeralKeyProvider {
    ...
    func optimizeRoute(locations: [CLLocationCoordinate2D], completion: @escaping (Data?) -> ()){
        ...
        let url = "https://api.mapbox.com/optimized-trips/v1/mapbox/driving/\(coords)?steps=false&geometries=geojson&access_token=pk.eyJ1Ijoic3Jpa2FudGhzcm52cyIsImEiOiJjajY0NDI0ejYxcDljMnFtcTNlYWliajNoIn0.jDevn4Fm6WBZUx7TDtys9Q"
